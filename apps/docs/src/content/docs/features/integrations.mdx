...
- **Pax8** syncs your clients and their subscription/license quantities, which you can map to organizations and link to recurring contract lines.
- **TD SYNNEX** provides live product price and availability you can import straight into your catalog.

The end-to-end workflow for importing distributor products into your catalog -- including TD SYNNEX EC Express live pricing -- is documented under [Product Catalog → Importing from distributor catalogs](/features/product-catalog/#importing-from-distributor-catalogs).
