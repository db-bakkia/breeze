...
- Parent design: `docs/superpowers/specs/ticketing/2026-06-09-native-ticketing-design.md` (§3 notifications, §4 email-to-ticket, §8 phasing, §8a extensibility)
