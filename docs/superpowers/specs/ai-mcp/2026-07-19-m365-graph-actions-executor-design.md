...
**Related:**
- `docs/superpowers/specs/integrations/2026-07-13-breeze-m365-control-plane-design.md` (control-plane architecture; this is stage 5 "Mutation executors")
- `docs/superpowers/specs/ai-mcp/2026-07-19-action-intents-phase2-google-headless-design.md` (Phase 2 Google headless — the worker-wiring template this mirrors)
