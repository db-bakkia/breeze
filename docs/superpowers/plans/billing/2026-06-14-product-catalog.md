...
**Spec:** `docs/superpowers/specs/billing/2026-06-14-product-catalog-design.md`
**Architecture frame:** `docs/superpowers/specs/billing/2026-06-14-billing-architecture-overview.md`
...
gh pr create --title "feat(catalog): product catalog (items, per-org pricing, bundles)" \
  --body "Implements docs/superpowers/specs/billing/2026-06-14-product-catalog-design.md (sub-project 1 of the billing/invoicing program). Partner-axis catalog_items + bundles, org-axis per-customer pricing, ticket_parts.catalog_item_id, RLS + forge tests, AI read tools, settings UI."
```
