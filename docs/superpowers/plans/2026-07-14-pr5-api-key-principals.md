...
**Scope:** SR2-15 from `docs/superpowers/specs/2026-07-11-core-authentication-hardening-design.md` — "Human-delegated API keys cannot outlive the creator's authority. Non-human automation uses an explicit service principal."
