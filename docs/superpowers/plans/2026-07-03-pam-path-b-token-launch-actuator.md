...
**Files:**
- Create: `docs/superpowers/plans/2026-07-03-pam-path-b-vm-validation.md` (checklist artifact — not code)
...
```bash
git add docs/superpowers/plans/2026-07-03-pam-path-b-vm-validation.md agent/internal/pamactuator/tokenlaunch_windows.go
