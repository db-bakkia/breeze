...
- Modify: `docs/superpowers/specs/pam/2026-06-10-helper-privileged-action-pam-governance-design.md` (append a short note)
...
At the end of `docs/superpowers/specs/pam/2026-06-10-helper-privileged-action-pam-governance-design.md`, append:
...
`docs/superpowers/plans/pam/2026-06-12-pam-config-policy-enablement.md`.
```

- [ ] **Step 3: Commit (repo files only)**

```bash
git add docs/superpowers/specs/pam/2026-06-10-helper-privileged-action-pam-governance-design.md
