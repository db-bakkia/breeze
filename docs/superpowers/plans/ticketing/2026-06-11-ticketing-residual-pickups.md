...
**Companion plan:** `docs/superpowers/plans/ticketing/2026-06-11-ticketing-sla-engine.md` (Phase 2 main thread). These pickups are independent of it and can land before, after, or interleaved.
