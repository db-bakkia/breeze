...
**Spec:** `docs/superpowers/specs/agent/2026-06-09-agent-systemd-sandbox-remote-terminal-design.md`
...
# Do not re-add them. See docs/superpowers/specs/agent/2026-06-09-agent-systemd-sandbox-remote-terminal-design.md
...
```bash
git add docs/superpowers/specs/agent/2026-06-09-agent-systemd-sandbox-remote-terminal-design.md docs/superpowers/plans/agent/2026-06-09-agent-systemd-sandbox-remote-terminal.md
