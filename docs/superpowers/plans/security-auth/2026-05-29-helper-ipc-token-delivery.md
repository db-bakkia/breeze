...
**Spec:** `docs/superpowers/specs/security-auth/2026-05-29-helper-ipc-token-delivery-design.md`
...
```bash
git add docs/superpowers/plans/security-auth/2026-05-29-helper-ipc-token-delivery.md
