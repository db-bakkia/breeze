...
The stock-image deferral is recorded both as a spec-file comment (top of `runtime-extensions.spec.ts`, "STOCK-IMAGE BUILD PROOF: DEFERRED TO PLAN 05" section) and by checking off the corresponding item in `docs/superpowers/plans/web-ui/2026-07-18-runtime-extension-platform-03-web-refined.md`'s "Plan Verification" list.
...
- `docs/superpowers/plans/web-ui/2026-07-18-runtime-extension-platform-03-web-refined.md` — checked off the "Stock-image conformance explicitly deferred to Plan 05" Plan Verification item. No other items checked (not verified live this session).
